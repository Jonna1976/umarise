...
class UmariseCore:
    ...
    def resolve(
        ...
        *,
        ...
        Returns the earliest attestation, or None if not found.
        """
        if origin_id:
    ...
    def verify(self, hash: str) -> Optional[VerifyResult]:
        ...
        Returns the origin record if found, None if no match.
        """
        try:
            data = self._request(
    ...
    def proof(self, origin_id: str) -> ProofResult:
        ...
        try:
            with urllib.request.urlopen(req, timeout=self.timeout) as resp:
                ...
                # 202 handled below via HTTPError
