  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <h4 className="text-[hsl(var(--landing-cream)/0.95)] font-medium text-sm">{title}</h4>
      </div>
...
export default function QuickStartSection() {
    ...
    <section id="quick-start" className="space-y-8">
      <div className="border border-[hsl(var(--landing-cream)/0.1)] rounded-lg p-6 bg-[hsl(var(--landing-cream)/0.02)]">
        ...
        <div className="space-y-8">
          <Step
            number="1"
            title="Check if the API is running"
  ...
  -d '{"hash":"sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}'`}
          ...
          <Step
            ...
            display={`curl '${BASE}/v1-core-resolve?origin_id=PASTE_ORIGIN_ID'`}
            singleLine={`curl '${BASE}/v1-core-resolve?origin_id=PASTE_ORIGIN_ID'`}
            expected={`{"origin_id":"...","hash":"sha256:...","hash_algo":"sha256","captured_at":"...","proof_status":"pending|anchored"}`}
            note="Use the origin_id from the step 2 response."
          />
  ...
  -d '{"hash":"sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}'`}
            ...
            note='Verify returns the first attestation for this hash (first-in-time resolution). With the test hash you may see an earlier captured_at with proof_status "anchored" - this is correct: the hash already existed. With your own file you will see your own attestation.'
          />
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-[hsl(var(--landing-cream)/0.08)]">
          ...
          <div className="space-y-2 text-xs text-[hsl(var(--landing-cream)/0.6)]">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="#health" className="text-[hsl(var(--landing-copper))] hover:underline font-mono">→ Full API Reference ↓</a>
            </div>
          </div>
        </div>
      </div>
