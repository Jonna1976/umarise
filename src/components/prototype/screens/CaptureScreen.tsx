...
export function CaptureScreen({ onCapture, onCaptureFile, isFirstVisit = false }: CaptureScreenProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── Top section: grows to push circle to vertical center ─────────── */}
      ...
      {/* ── Universal File Drop Zone — always visible, in flow ───────────── */}
      <motion.div
      ...
      >
        ...
        {!isFirstVisit && (
          <motion.p
            className="text-center font-garamond italic text-[10px] mt-6"
