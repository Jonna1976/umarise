      ...
      <main className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-12 text-landing-muted/80 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-4">
              Umarise is a neutral anchor record layer. It establishes proof that a digital artifact existed at a specific moment in time: hash + timestamp + anchor ID, before transformation, and enables later independent verification.
            </p>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-4">
              <li><span className="text-landing-copper">Establish anchor</span>: write-once, Bitcoin-anchored</li>
              <li><span className="text-landing-copper">Resolve metadata</span>: anchor_id → hash, timestamp, proof status</li>
            ...
            <p className="mt-4 text-landing-muted/60">
              It does not store content, interpret meaning, apply policy, or enforce governance. Those responsibilities remain intentionally outside the anchor layer.
            </p>
            <p className="mt-4 text-landing-cream/70">
          ...
          <section>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-landing-muted/70">
                  ...
                  <tr className="border-b border-landing-muted/10">
                    ...
                    <td className="py-2 pr-4">POST /v1-core-origins: hash → anchor_id + timestamp</td>
            ...
            <p className="mt-4 text-landing-muted/50 text-sm italic">
              Note: The Core API uses <code className="font-mono text-landing-copper/70">origin_id</code> as the technical field name for anchor_id. This is unchanged for backward compatibility. In all user-facing and partner-facing contexts, this identifier is referred to as anchor_id.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-landing-muted/70">
                  ...
                  <tr>
                    <td className="py-2 pr-4">Anchor metadata</td>
                    <td className="py-2 pr-4">anchor_id, timestamp, proof status</td>
            ...
            <p className="mt-4 text-landing-muted/50 text-sm">
              For a technical description of Anchor Records, see <Link to="/legal" className="text-landing-copper/70 hover:text-landing-copper transition-colors">umarise.com/legal</Link>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-4">
              ...
              <li>You need anchoring to be independently verifiable, not "trust us" but "verify it yourself"</li>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-4 text-landing-muted/60">
              ...
              <li>You need full provenance tracking (who edited what, when). That is C2PA, not anchoring</li>
              <li>You need to identify users by name. Anchor records contain no PII</li>
            </ul>
            <p className="mt-4 text-landing-muted/50 text-sm italic">
          ...
          <section>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-sm">
                ...
                <tbody className="text-landing-muted/70">
                  ...
                  <tr>
                    <td className="py-2 pr-4">Anchoring</td>
            ...
            <p className="text-landing-cream/70">
              A TSA anchors the finished result: the document, the contract, the signed artifact. Umarise anchors the unfinished state: the sketch, the first photo, the raw data before any system touches it.
            </p>
            <p className="mt-4 text-landing-muted/50 text-sm">
              Umarise is not an innovation layer. It is the externalization of anchoring itself.
            </p>
          </section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-landing-muted/60">
                  The core behavior of the anchor layer is fixed. Core v1 is frozen. No breaking changes, no feature additions, no version churn. What you integrate today works identically in five years.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-landing-muted/60">
                  The anchor layer is introduced carefully, one system at a time. Asynchronous communication by default. Synchronous discussion only when an invariant-level question emerges.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-4">
              <li>What exact moment in your system requires a verifiable anchor?</li>
              <li>What happens today if that moment is questioned?</li>
              <li>Why is internal evidence insufficient?</li>
              <li>What changes if that moment becomes externally verifiable?</li>
            </ul>
            <p className="mt-4 text-landing-muted/50 text-sm italic">
              If these answers are unclear, the anchor layer is likely premature.
            </p>
          </section>
          ...
          <section className="border-t border-landing-muted/10 pt-12">
            <p className="text-landing-cream/90 mb-4">
              Modern systems can transform data endlessly, but cannot independently prove what existed at a specific moment. As systems become more automated, distributed, and contested, anchoring must become a first-class primitive.
            </p>
            <p className="text-landing-copper italic">
              Umarise establishes anchors. Everything else remains external.
            </p>
          </section>
