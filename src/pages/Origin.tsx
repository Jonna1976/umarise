      ...
      <main className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-12 text-landing-muted/80 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-4 text-landing-cream/70">
              Anchor Records are enforced as immutable by database-level constraints and externally anchored via OpenTimestamps to the Bitcoin blockchain. The architecture is ledger-agnostic by design. The immutable record is independent of application-layer policy.
            </p>
