     ...
     <div className="min-h-screen bg-landing-deep text-landing-cream">
       ...
       <main className="max-w-3xl mx-auto px-6 py-12 md:py-20">
         ...
         <div className="space-y-12 text-landing-muted/80 leading-relaxed">
           ...
           {/* Context */}
           <section>
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">Context</h2>
             <p className="mb-4">
           ...
           {/* The Problem */}
           <section>
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">The Problem</h2>
             <p className="mb-4 text-landing-cream/90">
               The service that generates proof also controls the confirmation of that proof.
             </p>
             <p className="mb-4">
               Certificates live in dashboards. Validation runs through private endpoints. Access requires accounts. The proof is bound to the infrastructure that issued it. If the provider changes terms, goes offline, or ceases to exist, the proof becomes inaccessible or unverifiable.
             </p>
           ...
           {/* The Shift */}
           <section>
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">The Shift</h2>
             <p className="mb-4">
           ...
           {/* The Gap */}
           <section>
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">The Gap</h2>
             <p className="mb-4 text-landing-cream/90">
           ...
           <section className="border-l-2 border-landing-copper/30 pl-6">
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">The Provenance Gap in Automated Workflows</h2>
             <p className="mb-4 text-landing-cream/90 font-medium">
           ...
           {/* How It Works */}
           <section>
             <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">How It Works</h2>
           ...
           {/* What Umarise Is Not */}
            <section>
              <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">What the Anchor Layer Is Not</h2>
              <p className="text-landing-muted/70">
            ...
            <section className="border-t border-landing-muted/10 pt-12">
              <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">Learn More</h2>
            ...
            {/* Contact */}
            <section className="border-t border-landing-muted/10 pt-12 pb-12">
              <h2 className="text-sm font-medium tracking-wide text-landing-muted/70 uppercase mb-6">Contact</h2>
              <a
