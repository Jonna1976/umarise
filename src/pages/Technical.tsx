...
const sections = [
  { id: 'chain', label: 'From bytes to Bitcoin' },
  { id: 'proof', label: 'The proof file' },
  { id: 'scope', label: 'What an anchor proves' },
    ...
    <div className="min-h-screen bg-landing-deep text-landing-cream">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 flex gap-16">
        ...
        <nav className="hidden lg:block w-48 shrink-0">
          <div className="sticky top-24">
            ...
            <div className="mt-8 pt-6 border-t border-landing-muted/10 space-y-1.5">
              ...
              <a href="https://verify-anchoring.org" target="_blank" rel="noopener noreferrer" className="block text-[12px] text-landing-muted/30 hover:text-landing-copper transition-colors">Verifier ↗</a>
            </div>
          </div>
        </nav>
        ...
        <main className="max-w-2xl flex-1 min-w-0">
          ...
          {/* Section 1: The chain */}
          <section id="chain" className="mb-20 scroll-mt-24">
...
VERIFY.txt         # human-readable verification instructions`}</pre>
          ...
          {/* Section 3: Scope */}
          <section id="scope" className="mb-20 scroll-mt-24">
            <h2 className="font-serif text-xl mb-6 text-landing-cream">
          ...
          <section id="trust" className="mb-20 scroll-mt-24">
            <h2 className="font-serif text-xl mb-6 text-landing-cream">
              Trust model
            </h2>
