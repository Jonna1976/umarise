...
Gebruiker uploadt een proof-ZIP in de gallery (Gallery Anchor Detail screen).
...
| **Toegang** | Gallery, ZIP uploaden | Terminal / command line |
...
| **Bewijst** | "Deze ZIP hoort bij dit geregistreerde en geanchorde record" | "Dit bestand is ongewijzigd en bestond no later than [datum]" |
...
De externe flow is het **onafhankelijke bewijs** — juridisch bruikbaar, zero-dependency, zelfs als Umarise morgen niet meer bestaat.
...
Het verschil is de route. De in-app flow loopt via Umarise. De externe flow loopt via Bitcoin rechtstreeks.

---

*Verification Flows documentatie — 24 februari 2026.*
